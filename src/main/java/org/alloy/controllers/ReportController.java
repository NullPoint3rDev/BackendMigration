...
import org.alloy.services.report.ReportGenerationExecutor;
...
public class ReportController {
    ...
    public ResponseEntity<byte[]> generateWireConsumptionReportNew(
        ...
        try {
            return reportGenerationExecutor.buildWireConsumptionReport(generationRequest).toResponseEntity();
        } catch (IllegalArgumentException e) {
    ...
    public ResponseEntity<byte[]> generateWelderWorkReport(
        ...
        try {
            return reportGenerationExecutor.buildWelderWorkReport(generationRequest).toResponseEntity();
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().build();
        } catch (Exception e) {
    ...
    public ResponseEntity<byte[]> generateEquipmentWorkReport(
        ...
        try {
            return reportGenerationExecutor.buildEquipmentWorkReport(generationRequest).toResponseEntity();
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().build();
        } catch (Exception e) {
    ...
    public ResponseEntity<byte[]> generateEquipmentMalfunctionReport(
        ...
        try {
            return reportGenerationExecutor.buildEquipmentMalfunctionReport(generationRequest).toResponseEntity();
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().build();
        } catch (Exception e) {
