...
public interface WeldingMachineStateRepository extends JpaRepository<WeldingMachineState, Long> {
    ...
    List<WeldingMachineState> findByWeldingMachineIdOrderByDateCreatedDesc(Integer weldingMachineId);
    ...
    @Query("SELECT wms FROM WeldingMachineState wms WHERE wms.weldingMachineId = :weldingMachineId AND wms.weldingMachineStatus = :status ORDER BY wms.dateCreated DESC")
    List<WeldingMachineState> findByWeldingMachineIdAndStatus(
            @Param("weldingMachineId") Integer weldingMachineId,
